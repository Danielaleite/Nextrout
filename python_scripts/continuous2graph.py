...
def graph_extraction_from_dat_files(
	...
	'''
	new_dir = '../muffe_sparse_optimization/simplifications/'+folder_path[2:]
	try:
		os.mkdir(new_dir)
	except OSError:
		print ("Creation of the directory %s failed." % new_dir)

	new_dir = '../muffe_sparse_optimization/simplifications/'+folder_path[2:]+'/'+funct
	try:
		os.mkdir(new_dir)
	except OSError:
		print ("Creation of the directory %s failed." % new_dir)
	...
	G_bar, G_triang, dict_seq, max_ = preprocessing_cont(
