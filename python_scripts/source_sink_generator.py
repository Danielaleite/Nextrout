...
def fsource(x, y, flag):
    ...
    if flag == "signal_prop":
        ...
        if x > 0.2 and x < 0.8 and y > 0.5 and y < 0.7:
            z = 1
    # -----------------------------------------------------------------
    if (
        flag == "1_rect"
        ...
        if math.sqrt((x - 0.2) ** 2 + (y - 0.5) ** 2) <= radio:
            z = 1
        if flag == "1_obstacles" or flag == "3_obstacles":
            if math.sqrt((x - 0.5) ** 2 + (y - 0.5) ** 2) <= radio:
                z = 1
    # ------------------------------------------------------------------------------------
    if (
        flag == "2_rect"
        ...
        if (
            math.sqrt((x - 0.2) ** 2 + (y - 0.2) ** 2) <= radio
            or math.sqrt((x - 0.2) ** 2 + (y - 0.8) ** 2) <= radio
        ):
            z = 1
        if flag == "2_obstacles" or flag == "3_obstacles":
            if (
                math.sqrt((x - 0.4) ** 2 + (y - 0.3) ** 2) <= radio
                or math.sqrt((x - 0.4) ** 2 + (y - 0.7) ** 2) <= radio
            ):
                z = 1
    # -----------------------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------------------
        ...
        radio = 0.01
        if math.sqrt((x - 0.5) ** 2 + (y - 0.8) ** 2) <= 0.05:
            z = 1
    # -----------------------------------------------------------------------------------
    elif flag == "pp_paper":
        radio = 0.05
        if (
            math.sqrt((x - 0.5) ** 2 + (y - 0.8) ** 2) <= 2 * radio
            or math.sqrt((x - 0.2) ** 2 + (y - 0.8) ** 2) <= 2 * radio
            or math.sqrt((x - 0.8) ** 2 + (y - 0.8) ** 2) <= 2 * radio
            or math.sqrt((x - 0.0) ** 2 + (y - 0.6) ** 2) <= 2 * radio
            or math.sqrt((x - 0.0) ** 2 + (y - 1) ** 2) <= 2 * radio
            or math.sqrt((x - 0.8) ** 2 + (y - 1) ** 2) <= 2 * radio
            or math.sqrt((x - 0.4) ** 2 + (y - 1) ** 2) <= 2 * radio
            or math.sqrt((x - 0.7) ** 2 + (y - 0.9) ** 2) <= 2 * radio
            or math.sqrt((x - 0.35) ** 2 + (y - 0.55) ** 2) <= 2 * radio
            or math.sqrt((x - 0.35) ** 2 + (y - 1) ** 2) <= 2 * radio
    ...
    if flag == "3rc":
        if (x > x1 and x < x2 and y > y1 and y < y2) or (
            x > x1 and x < x2 and y > y3 and y < y4
        ):
            z = 1
    # -----------------------------------------------------------------------------------
    ...
    if flag == "3rch":
        if (x > x9 and x < x10 and y > y9 and y < y10) or (
            x > x9 and x < x10 and y > y11 and y < y12
        ):
            z = 1
    # -----------------------------------------------------------------------------------
    ...
    if flag == "3rcl":
        if (x > x13 and x < x14 and y > y13 and y < y14) or (
            x > x13 and x < x14 and y > y15 and y < y16
        ):
            z = 1

    # -----------------------------------------------------------------------------------
    x17, x18, y17, y18, y19, y20, y21, y22, x19, x20 = (
        0.125,
        0.225,
        0.125,
        0.3,
    ...
    if flag == "5rcm":
        if (
            (x > x17 and x < x18 and y > y17 and y < y18)
    ...
    # -----------------------------------------------------------------------------------
    x21, x22, y17, y18, y19, y20, y21, y22, x19, x20 = (
        0.125,
        0.225,
        0.125,
        0.3,
    ...
    if flag == "5rch":
        if (
            (x > x21 and x < x22 and y > y17 and y < y18)
            or (x > x17 and x < x18 and y > y19 and y < y20)
            or (x > x17 and x < x18 and y > y21 and y < y22)
            or (x > x19 and x < x20 and y > y19 and y < y20)
        ):
    ...
    if flag == "5rch2":
        if (
            (x > x21 and x < x22 and y > y17 and y < y18)
            or (x > x21 and x < x22 and y > y19 and y < y20)
            or (x > x21 and x < x22 and y > y21 and y < y22)
            or (x > x19 and x < x20 and y > y19 and y < y20)
        ):
            z = 1
    # -----------------------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------------------
    x17, x18, y17, y18, y19, y20, y21, y22 = (
        0.125,
        0.225,
        0.125,
        0.3,
...
def fsink(x, y, flag):
    ...
    if flag == "4_circles":
        if (
            (math.sqrt((x - 0.35) ** 2 + (y - 0.35) ** 2) <= radio)
            or (math.sqrt((x - 0.35) ** 2 + (y - 0.65) ** 2) <= radio)
            or (math.sqrt((x - 0.65) ** 2 + (y - 0.35) ** 2) <= radio)
            or (math.sqrt((x - 0.65) ** 2 + (y - 0.65) ** 2) <= radio)
        ):
            z = 1
    # -----------------------------------------------------------------------------------
    if flag == "signal_prop":
        # taken from https://www.pnas.org/content/114/20/5136
        if x > 0.2 and x < 0.8 and y > 0.1 and y < 0.5:
            z = 1

    # -----------------------------------------------------------------------------------
    if flag == "1_rect":
        if math.sqrt((x - 0.8) ** 2 + (y - 0.5) ** 2) <= radio:
            z = 2
    ...
    # -----------------------------------------------------------------------------------
        ...
        y0 = 0.04
        if (
            (math.sqrt((x - 0.05) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.1) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.15) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.20) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.25) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.30) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.35) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.40) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.45) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.50) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.55) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.60) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.65) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.70) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.75) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.80) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.85) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.90) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.95) ** 2 + (y - y0) ** 2) <= radio)
            or (math.sqrt((x - 0.99) ** 2 + (y - y0) ** 2) <= radio)
        ):
            z = 1
    # -----------------------------------------------------------------------------------
    elif flag == "rc":
    ...
    # -----------------------------------------------------------------------------------
        ...
        radio = 0.01
        if math.sqrt((x - 0.5) ** 2 + (y - 0.2) ** 2) <= 0.05:
            z = 1
    # -----------------------------------------------------------------------------------
    elif flag == "pp_paper":
        radio = 0.05
        if (
            math.sqrt((x - 0.5) ** 2 + (y - 0.2) ** 2) <= 2 * radio
            or math.sqrt((x - 0.8) ** 2 + (y - 0.2) ** 2) <= 2 * radio
            or math.sqrt((x - 0.2) ** 2 + (y - 0.2) ** 2) <= 2 * radio
            or math.sqrt((x - 0.35) ** 2 + (y - 0.1) ** 2) <= 2 * radio
            or math.sqrt((x - 0.1) ** 2 + (y - 0.1) ** 2) <= 2 * radio
            or math.sqrt((x - 0.75) ** 2 + (y - 0.0) ** 2) <= 2 * radio
            or math.sqrt((x - 1) ** 2 + (y - 0.0) ** 2) <= 6 * radio
        ):
            z = 1
    ...
    # -----------------------------------------------------------------------------------
        ...
        radio = 0.01
        if (
            math.sqrt((x - 0.5) ** 2 + (y - 0.5) ** 2) <= 0.45
            and not math.sqrt((x - 0.5) ** 2 + (y - 0.5) ** 2) <= radio
        ):
            z = 1
    # --------------------------------------------------------------------------
    ...
    if flag == "6rcl":
        if (x > x13 and x < x14 and y > y13 and y < y14) or (
            x > x01 and x < x02 and y > y01 and y < y02
        ):
            z = 1
...
def source_plot(flag, ax=None):
    ...
    if flag == "rect_cnst":
        ...
        x17, x18, x21, x22, y17, y18, y19, y20, y21, y22, x19, x20 = (
            0.125,
            0.225,
            0.125,
            0.225,
        ...
        return_ax = True
        circle1 = plt.Circle((0.2, 0.5), 0.05, color="green", fill=False)
        ax.add_artist(circle1)
        if flag == "1_obstacles" or flag == "3_obstacles":
            circle2 = plt.Circle((0.5, 0.5), 0.05, color="green", fill=False)
        ...
        return_ax = True
        circle11 = plt.Circle((0.2, 0.2), 0.05, color="green", fill=False)
        circle12 = plt.Circle((0.2, 0.8), 0.05, color="green", fill=False)
        ax.add_artist(circle11)
        ax.add_artist(circle12)
        if flag == "2_obstacles" or flag == "3_obstacles":
            circle21 = plt.Circle((0.4, 0.3), 0.05, color="green", fill=False)
            circle22 = plt.Circle((0.4, 0.7), 0.05, color="green", fill=False)
            ax.add_artist(circle21)
            ax.add_artist(circle22)
    elif flag == "center":
        return_ax = True
        circle1 = plt.Circle((0.5, 0.5), 0.01, color="green", fill=False)
        ax.add_artist(circle1)
    else:
...
def sink_plot(flag, ax=None):
    ...
    if flag == "rect_cnst":
        ...
        return_ax = True
        circle1 = plt.Circle((0.5, 0.5), 0.45, color="red", fill=False)
        ax.add_artist(circle1)
    elif flag == "3rc":
        x1, x2, y1, y2 = 0.625, 0.875, 0.45, 0.575
        ...
        return_ax = True
        circle1 = plt.Circle((0.8, 0.5), 0.05, color="red", fill=False)
        ax.add_artist(circle1)
    else:
        print("Flag not defined!")
    if return_ax == True:
...
def rect_plot(x1, x2, y1, y2, ax, flag="source"):
    ...
    pos_source = {0: (x1, y1), 1: (x1, y2), 2: (x2, y2), 3: (x2, y1), 4: (x1, y1)}
    if flag == "source":
        color = "g"
    elif flag == "sink":
        color = "r"
