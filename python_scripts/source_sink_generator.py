...
def source_sink_preprocess(folder_name):
    ...
    command = '../globals/axpy_timedata/axpy.out -1.0 ' + sink +'  '+source+'  '+new_forcing
    ...
    command = '../geometry/interpolate_timedata/interpolate_timedata.out'+'  '+subgrid+'  '+parent+'  '+new_forcing+'  '+new_forcing_subgrid
    ...
    command = '../p1galerkin/makerhs/makerhs.out'+' '+subgrid+' '+new_forcing_subgrid+' '+rhs
    os.system(command)
    rhs_integrated = folder_name+'/input/rhs_integrated.dat'
    print('Checking balance of the rhs.')
    command = 'python ../globals/python_timedata/balance.py'+' '+rhs+'  '+rhs_integrated
    os.system(command)
    ...
    command = '../geometry/timedata2vtk/timedata2vtk.out'+' '+grid+'  '+source+' '+source_vtk
    os.system(command)
    command = '../geometry/timedata2vtk/timedata2vtk.out'+' '+grid+'  '+sink+' '+sink_vtk
    os.system(command)
